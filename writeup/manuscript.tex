...
\subsection{Cross-linguistic variation}\label{cross-linguistic-variation}
...
Following the general design of (\textbf{samuelson1999?}), in Studies 1a and 1b we asked English-speaking raters to judge lexical properties of early learned nouns. Using pre-existing cross-linguistic conceptual mappings, we then map these ratings to the early vocabularies of children acquiring different languages. These groups of ratings then create a proxy for the cluster of noun concepts being learned by children in different cultures.
...
\section{Study 1a: Rating lexical properties in English}\label{study-1a-rating-lexical-properties-in-english}
...
\section{Study 1b: Retest ratings for lexical properties in English}\label{study-1b-retest-ratings-for-lexical-properties-in-english}
...
\section{Study 2a: Rating lexical statistics in Korean}\label{study-2a-rating-lexical-statistics-in-korean}
...
\section{Study 2b: In-lab Korean ratings}\label{study-2b-in-lab-korean-ratings}

\section{Study 3: Predicting age of acquisition}\label{study-3-predicting-age-of-acquisition}
